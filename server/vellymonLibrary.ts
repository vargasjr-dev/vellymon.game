...
const ALL_VELLYMONS: VellymonTemplate[] = [
  ...
  { id: 9, name: "Coppercog", archetype: "balanced", hp: 80, attack: 12, speed: 4, attacks: [T.strike, T.lob], flavor: "Mechanical vellymon made of spinning copper gears.", specialPowerId: "overclock", imageUrl: "/vellymon/coppercog.png" },
