...
const ALL_VELLYMONS: VellymonTemplate[] = [
  ...
  { id: 7, name: "Buldrok", archetype: "tank", hp: 120, attack: 8, speed: 1, attacks: [T.poke, T.slam], flavor: "An ancient stone golem. Slow but nearly indestructible.", specialPowerId: "stone-skin", imageUrl: "/vellymon/buldrok.png" },
  ...
  { id: 10, name: "Coralord", archetype: "tank", hp: 95, attack: 11, speed: 3, attacks: [T.strike, T.slam], flavor: "Coral reef creature. Slow on land, king of the shallows.", specialPowerId: "reef-armor", imageUrl: "/vellymon/coralord.png" },
