...
const ALL_VELLYMONS: VellymonTemplate[] = [
  { id: 1, name: "Aerobolt", archetype: "speedster", hp: 65, attack: 8, speed: 8, attacks: [T.snipe, T.strike], flavor: "Rides its own shockwave like a surfboard.", specialPowerId: "shockwave-surfer", imageUrl: "/vellymon/aerobolt.png" },
  { id: 2, name: "Aquaplex", archetype: "balanced", hp: 73, attack: 12, speed: 5, attacks: [T.snipe, T.strike], flavor: "Water creature that adapts to any situation.", specialPowerId: "adaptive-flow", imageUrl: "/vellymon/aquaplex.png" },
  { id: 3, name: "Barrikade", archetype: "tank", hp: 102, attack: 11, speed: 2, attacks: [T.poke, T.strike], flavor: "Literally a walking barricade. Blocks everything.", specialPowerId: "iron-curtain", imageUrl: "/vellymon/barrikade.png" },
  { id: 4, name: "Blastova", archetype: "glass_cannon", hp: 45, attack: 20, speed: 4, attacks: [T.poke, T.nuke], flavor: "A living supernova. Bright, hot, and short-lived.", specialPowerId: "supernova-burst", imageUrl: "/vellymon/blastova.png" },
  { id: 5, name: "Blinkatt", archetype: "speedster", hp: 42, attack: 11, speed: 10, attacks: [T.snipe, T.strike], flavor: "Blinks in and out of existence between attacks.", specialPowerId: "phase-shift", imageUrl: "/vellymon/blinkatt.png" },
  { id: 6, name: "Breezekin", archetype: "balanced", hp: 75, attack: 13, speed: 5, attacks: [T.poke, T.lob], flavor: "Kin of the wind. Light on its feet, steady aim.", specialPowerId: "tailwind", imageUrl: "/vellymon/breezekin.png" },
  { id: 7, name: "Buldrok", archetype: "tank", hp: 120, attack: 8, speed: 1, attacks: [T.poke, T.slam], flavor: "An ancient stone golem. Slow but nearly indestructible.", specialPowerId: "earthen-bulwark", imageUrl: "/vellymon/buldrok.png" },
  { id: 8, name: "Cloudpuff", archetype: "support", hp: 78, attack: 8, speed: 7, attacks: [T.poke, T.chip], flavor: "A tiny cloud that floats just above the ground.", specialPowerId: "rain-dance", imageUrl: "/vellymon/cloudpuff.png" },
  { id: 9, name: "Coppercog", archetype: "balanced", hp: 80, attack: 12, speed: 4, attacks: [T.strike, T.lob], flavor: "Mechanical vellymon made of spinning copper gears.", specialPowerId: "gear_grind", imageUrl: "/vellymon/coppercog.png" },
  { id: 10, name: "Coralord", archetype: "tank", hp: 95, attack: 11, speed: 3, attacks: [T.strike, T.slam], flavor: "Coral reef creature. Slow on land, king of the shallows.", specialPowerId: "tide-harvest", imageUrl: "/vellymon/coralord.png" },
  { id: 11, name: "Cosmog", archetype: "balanced", hp: 90, attack: 10, speed: 4, attacks: [T.poke, T.strike], flavor: "Cosmic origins. The most mysterious vellymon of all.", specialPowerId: "warp-strike", imageUrl: "/vellymon/cosmog.png" },
  { id: 12, name: "Cragthorn", archetype: "tank", hp: 110, attack: 10, speed: 1, attacks: [T.strike, T.slam], flavor: "Covered in thorny rock formations. Touch at your peril.", specialPowerId: "thorns", imageUrl: "/vellymon/cragthorn.png" },
  { id: 13, name: "Crimshard", archetype: "glass_cannon", hp: 47, attack: 17, speed: 6, attacks: [T.poke, T.nuke], flavor: "Red crystal shards orbit it like tiny daggers.", specialPowerId: "crystal-barrage", imageUrl: "/vellymon/crimshard.png" },
  { id: 14, name: "Dashpaw", archetype: "speedster", hp: 55, attack: 13, speed: 6, attacks: [T.poke, T.snipe], flavor: "Paw prints everywhere but you never see it pass.", specialPowerId: "phantom-sprint", imageUrl: "/vellymon/dashpaw.png" },
  ...
  { id: 60, name: "Voidclaw", archetype: "glass_cannon", hp: 37, attack: 17, speed: 5, attacks: [T.slam, T.lob], flavor: "Reaches through tiny void portals to strike.", specialPowerId: "void_rend", imageUrl: "/vellymon/voidclaw.png" },
  ...
  { id: 64, name: "Zipfang", archetype: "speedster", hp: 40, attack: 12, speed: 10, attacks: [T.poke, T.strike], flavor: "So fast it bites before you see it move.", specialPowerId: "blood_rush", imageUrl: "/vellymon/zipfang.png" },
];
