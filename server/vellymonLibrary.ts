...
const TANKS: VellymonTemplate[] = [
  ...
  { id: 5,  name: "Tundrak",    archetype: "tank", hp: 105, attack: 10, speed: 2, attacks: [T.strike, T.slam], flavor: "Frost-covered mammoth that freezes the ground it walks on." },
  ...
  { id: 8,  name: "Titanog",    archetype: "tank", hp: 98,  attack: 11, speed: 2, attacks: [T.strike, T.slam], flavor: "Titanium-boned creature from deep underground." },
...
const SPEEDSTERS: VellymonTemplate[] = [
  ...
  { id: 16, name: "Voltwing",   archetype: "speedster", hp: 48,  attack: 11, speed: 9,  attacks: [T.poke, T.strike], flavor: "Electric wings that crackle with each flap." },
...
const GLASS_CANNONS: VellymonTemplate[] = [
  ...
  { id: 28, name: "Voidclaw",   archetype: "glass_cannon", hp: 50,  attack: 19, speed: 4, attacks: [T.slam, T.lob],   flavor: "Reaches through tiny void portals to strike." },
  ...
  { id: 31, name: "Crimshard",  archetype: "glass_cannon", hp: 55,  attack: 18, speed: 4, attacks: [T.poke, T.nuke],  flavor: "Red crystal shards orbit it like tiny daggers." },
  ...
  { id: 33, name: "Wrecktor",   archetype: "glass_cannon", hp: 58,  attack: 16, speed: 5, attacks: [T.poke, T.slam],  flavor: "Built to wreck. Nothing else. Just wreck." },
...
const SUPPORTS: VellymonTemplate[] = [
  ...
  { id: 39, name: "Dewdrop",    archetype: "support", hp: 70,  attack: 5,  speed: 8, attacks: [T.chip, T.snipe],  flavor: "A sentient dewdrop. Surprisingly hard to squish." },
  ...
  { id: 41, name: "Scoopuff",   archetype: "support", hp: 73,  attack: 6,  speed: 8, attacks: [T.chip, T.poke],   flavor: "Scoops up energy pellets with its fluffy cheeks." },
  { id: 42, name: "Nectarb",    archetype: "support", hp: 75,  attack: 7,  speed: 7, attacks: [T.chip, T.snipe],  flavor: "Drips sweet nectar that converts to pure energy." },
  ...
  { id: 46, name: "Tidalmini",  archetype: "support", hp: 80,  attack: 7,  speed: 7, attacks: [T.snipe, T.poke],  flavor: "Miniature tidal wave. Splashes harmlessly but fast." },
...
const BALANCED: VellymonTemplate[] = [
  ...
  { id: 52, name: "Breezekin",  archetype: "balanced", hp: 75,  attack: 12, speed: 5, attacks: [T.poke, T.lob],      flavor: "Kin of the wind. Light on its feet, steady aim." },
  { id: 53, name: "Ironpup",    archetype: "balanced", hp: 76,  attack: 13, speed: 4, attacks: [T.strike, T.snipe],  flavor: "An iron-coated pup. Loyal, tough, decent in a fight." },
  ...
  { id: 55, name: "Frostfawn",  archetype: "balanced", hp: 78,  attack: 12, speed: 5, attacks: [T.snipe, T.lob],     flavor: "A frost-touched fawn. Graceful and deceptively tough." },
  ...
  { id: 57, name: "Starveil",   archetype: "balanced", hp: 80,  attack: 11, speed: 5, attacks: [T.poke, T.snipe],    flavor: "Veiled in starlight. Hard to read, harder to predict." },
  ...
  { id: 59, name: "Pebblink",   archetype: "balanced", hp: 82,  attack: 11, speed: 5, attacks: [T.poke, T.lob],      flavor: "A blinking pebble. Don't underestimate small things." },
  { id: 60, name: "Duskfin",    archetype: "balanced", hp: 83,  attack: 12, speed: 4, attacks: [T.strike, T.snipe],  flavor: "Emerges at dusk. Thrives in twilight conditions." },
  ...
  { id: 63, name: "Prismite",   archetype: "balanced", hp: 88,  attack: 10, speed: 5, attacks: [T.snipe, T.lob],     flavor: "Refracts light into rainbow patterns. Beautiful fighter." },
